...
SKILL_KW = {"HTML5 & Semantic Markup": ["html"], "CSS3 & Flexbox/Grid": ["css", "flexbox", "grid"], "JavaScript (ES6+)": ["javascript", " js"],
            ...
            "Docker / Containerization": ["docker", "containeriz", "part 12: containers"], "Kubernetes (K8s)": ["kubernetes"], "AWS Core (EC2, S3, IAM)": ["aws"], "Microsoft Azure Basics": ["azure"], "Google Cloud Platform (GCP)": ["google cloud", "gcp"],
