...
const ASSETS = ["./", "./index.html", "./css/app.css", "./vendor/qrcode.min.js", "./js/main.js", "./js/state.js", "./js/i18n.js", "./js/ui.js", "./js/glossary.js", "./js/engine.js", "./js/credentials.js", "./js/auth.js", "./js/firebase-config.js",
  "./js/views/home.js", "./js/views/intake.js", "./js/views/quiz.js", "./js/views/dashboard.js", "./js/views/summary.js", "./js/views/account.js", "./js/views/add.js", "./js/views/about.js", "./js/views/help.js", "./js/prompts.js",
  "./js/data/catalogue.js", "./js/data/picks.js", "./js/data/subjects.js", "./js/data/tracks.js", "./js/data/quiz_bank.js", "./js/data/capstones.js", "./js/data/glossary.js", "./js/data/work_categories.js", "./js/data/reference_pathways.js", "./js/data/ai_topics.js", "./js/data/synthetic_profiles.js", "./js/data/job_skills.js", "./js/data/completion_bank.js"];
