...
export function render(root, ctx) {
  ...
  root.innerHTML = `
    ...
    ${sec(esc(tt({ en: "What this does differently", hi: "यह अलग क्या करता है" })), li([
      ...
      esc(tt({ en: "An adaptive placement check cross-checks self-rating against demonstrated competence before any path is built.", hi: "रास्ता बनने से पहले एक अनुकूली प्लेसमेंट जांच आत्म-मूल्यांकन को प्रदर्शित क्षमता से मिलाती है।" })),
    ...
    ${sec(esc(tt({ en: "How Claude is used", hi: "Claude का उपयोग कैसे हुआ" })), li([
      esc(tt({ en: "Authoring the reference data with a mentor's judgment: 56 capstones with acceptance criteria, the 116-item placement bank, the bilingual glossary, 13 reference pathways, and the anonymised work categories were drafted with Claude and checked against the catalogue.", hi: "मेंटर के विवेक से संदर्भ डेटा लिखना: 56 कैपस्टोन, 116 प्लेसमेंट सवाल, द्विभाषी शब्दकोश, 13 संदर्भ रास्ते और अनाम काम श्रेणियां Claude से बनाई और कैटलॉग से जांची गईं।" })),
    ...
    ${sec(esc(tt({ en: "90-second demo", hi: "90 सेकंड का डेमो" })), `<ol style="padding-left:18px;margin:0" class="stack">
      ...
      <li>${esc(tt({ en: "Placement: answer two questions correctly and watch the level move up; the result screen explains the difference from the self-rating.", hi: "प्लेसमेंट: दो सवाल सही दें और स्तर ऊपर जाते देखें; परिणाम स्क्रीन आत्म-मूल्यांकन से अंतर समझाती है।" }))}</li>
